# cm-plugin 工作流(Chrome 插件版) · 使用与配置手册(v0.2.2)
...
装完看最后一行:**"完成(已安装版本: v0.2.2)"**——显示别的号就说明装的不是最新版。
...
**期待结果**:首行显示 `安装版本: v0.2.2`,版本一致性行显示"一致",结论 PASSED。
...
*版本 v0.2.2 · 反馈问题请附 /cm-plugin:check 首行的版本号*
